...
$(document).on("change","#_discount_input",function(){
 ...
 var single_row =  `<tr class="_voucher_row">
                      ...
                      <td>
                      <input type="hidden" name="purchase_account_id[]" class="form-control purchase_account_id" />
                      </td>
...
var _purchase_row_single =`<tr class="_purchase_row">
                                              ...
                                              <td>
                                              <input type="hidden" name="purchase_detail_id[]" class="form-control purchase_detail_id" />
                                              </td>
                                              <td>

...
function _stock_in_purchase_row_add(event){
  ...
  $("._stock_in__item_row_count").val(_stock_in__item_row_count)
      ...
      $("#_stock_in_area__purchase_details").append(`<tr class="_purchase_row">
                                              ...
                                              <td class="@if($_show_barcode==0) display_none @endif">
                                                ...
                                                <input type="text"  name="_stock_in__barcode[]" class="form-control _stock_in__barcode  ${_item_row_count}__barcode " value="" id="${_item_row_count}___stock_in_barcode"  >

                                                <input type="hidden" name="_stock_in__ref_counter[]" value="${_item_row_count}" class="_stock_in__ref_counter" id="${_item_row_count}___stock_in_ref_counter">
                                              </td>

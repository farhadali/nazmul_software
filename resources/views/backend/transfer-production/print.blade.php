...
<div class="_report_button_header">
 <a class="nav-link"  href="{{url('transfer-production')}}" role="button"><i class="fa fa-arrow-left"></i></a>
 @can('transfer-production-edit')
    <a class="nav-link"  title="Edit" href="{{ route('transfer-production.edit',$data->id) }}">
       ...
       <table class="table table-bordered">
        <thead style="background: #fff;color: #000;;border:0px solid #fff;">
          <tr style="background: #fff;color: #000;border:0px solid #fff;">
            <td style="background: #fff;color: #000;border:0px solid #fff;" colspan="7" style="text-align: center;">
        ...
        <tbody>
          <tr>
          <td colspan="7" class="text-left" > <b>Stock In</b></td>
         </tr>
          <tr>
            <th>ID</th>
            <th>Item</th>
          ...
          <tr>
          <td colspan="7" class="text-left" > <b>Stock Out</b></td>
         </tr>
          ...
          <tr>
            ...
            @php
              ...
              <tr>
            <td colspan="3" class="text-left"><b>Total</b></td>
            <td><b>{{ _report_amount($_stock_out_qty ?? 0 ) }} </b></td>
            <td colspan="2"></td>

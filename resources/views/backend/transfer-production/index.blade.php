        ...
        <div class="row mb-2">
          <div class="col-sm-12" style="display: flex;">
            ...
            <ol class="breadcrumb float-sm-right ml-2">
               @can('transfer-production-create')
              <li class="breadcrumb-item active">
                        <a title="Add New" class="btn btn-success btn-sm" href="{{ route('transfer-production.create') }}"> <i class="nav-icon fas fa-plus"></i> </a>
               </li>
              @endcan
            </ol>
          </div>
            ...
            <div class="card">
              <div class="card-header border-0 mt-1">
                <div class="row">
                   ...
                   @endphp
                    <div class="col-md-4">
                       @include('backend.transfer-production.search')
                    </div>
                    <div class="col-md-8">
                      <div class="d-flex flex-row justify-content-end">
                         @can('transfer-production-print')
                ...
                <div class="table-responsive">
                  ...
                  <table class="table table-bordered _list_table">
                      ...
                      @endphp
                             ...
                             <td style="display: flex;">
                              <div class="dropdown mr-1">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                     <a class="dropdown-item " href="{{url('transfer-production/print')}}/{{$data->id}}" >
                                         View & Print
                                      </a>
                                     <a class="dropdown-item " href="{{url('transfer-production/stock-in')}}/{{$data->id}}" >
                                         Stock In Print Print
                                      </a>
                                     <a class="dropdown-item " href="{{url('transfer-production/stock-out')}}/{{$data->id}}" >
                                         Stock Out Print
                                      </a>
                                     @can('transfer-production-edit')
                                        <a class="dropdown-item " href="{{ route('transfer-production.edit',$data->id) }}" >
                                          Edit
                                        </a>
                                    @endcan
                        ...
                        @endforeach
                        <tr>
                          <td colspan="10" class="text-left"><b>Total</b></td>

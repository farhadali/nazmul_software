      ...
      <div class="container-fluid">
        ...
        @endif
            ...
            @endif
                     ...
                     <div class="row">
                         <select id="_account_ledger_id" class="form-control select2 _account_ledger_id multiple_select" name="_account_ledger_id[]" multiple required size="6" >
            ...
            @endif >{{$group->_name}}</option>
                     ...
                     <div class="row mt-3">
                         ...
                         <div class="col-xs-6 col-sm-6 col-md-6 ">
                                     <a href="{{url('reset-date-wise-sales-return')}}" class="btn btn-danger form-control" title="Search Reset"><i class="fa fa-retweet mr-2"></i> </a>
                        </div>
                        <br><br>
                     </div>
                    {!! Form::close() !!}

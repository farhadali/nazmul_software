            ...
            <tr>
             ...
             @php
                ...
                @forelse($value as $l_key=>$l_val)
                  ...
                  <!-- <tr>
                    <td colspan="2" style="text-align: left;background: #f5f9f9;">&nbsp; &nbsp;&nbsp; &nbsp; <b>Sub Total of {{ $l_key ?? '' }}: </b> </td>
                    <td style="text-align: right;background: #f5f9f9;"><b>{{ _report_amount($_running_sub_opening_dr ?? 0) }}</b> </td>
                    <td style="text-align: right;background: #f5f9f9;"><b>{{ _report_amount($_running_sub_opening_cr ?? 0) }}</b> </td>
                    <td style="text-align: right;background: #f5f9f9;"><b>{{ _report_amount($_running_sub_current_dr ?? 0) }}</b> </td>
                    <td style="text-align: right;background: #f5f9f9;"><b>{{ _report_amount($_running_sub_current_cr ?? 0) }}</b> </td>
                    <td style="text-align: right;background: #f5f9f9;"><b>{{ _report_amount($_running_sub_closing_dr ?? 0) }}</b> </td>
                    <td style="text-align: right;background: #f5f9f9;"><b>{{ _report_amount($_running_sub_closing_cr ?? 0) }}</b> </td>

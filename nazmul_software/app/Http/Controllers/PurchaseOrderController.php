   ...
   function __construct()
    ...
    public function index(Request $request)
    {
       ...
       if($request->has('limit')){
        ...
        $datas = PurchaseOrder::with(['_master_branch','_master_details','_ledger']);
    ...
    public function create()
    {
       ...
       return view('backend.purchase-order.create',compact('account_types','page_name','account_groups','branchs','permited_branch','permited_costcenters','store_houses','form_settings','inv_accounts','p_accounts','dis_accounts','categories','units'));
    }
     ...
     public function edit($id)
    {
       ...
       return view('backend.purchase-order.edit',compact('account_types','page_name','account_groups','branchs','permited_branch','permited_costcenters','store_houses','form_settings','inv_accounts','p_accounts','dis_accounts','categories','units','data'));
    }
